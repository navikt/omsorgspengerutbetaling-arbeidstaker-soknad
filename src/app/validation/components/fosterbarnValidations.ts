...
export const listeAvFosterbarnIsValid = (listeAvFosterbard: Fosterbarn[]): boolean => {
    const isValid: boolean = listeAvFosterbard.map((fosterbarn: Fosterbarn) => {
...
export const harFosterbarnOgListeAvFosterbarnIsValid = (harFosterbarn: YesOrNo, listeAvFosterbarn: Fosterbarn[]): boolean => {
    if (
